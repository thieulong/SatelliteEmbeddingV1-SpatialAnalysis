...
DEFAULT_PROJECT = Path("GEE_BassCoast_Data")
DEFAULT_OUTPUT = Path("BassCoast_Phase9_Map_Data_Preparation_outputs")
DEFAULT_THRESHOLDS = Path(
    "BassCoast_Phase2_Pixel_Sampling_outputs/tables/phase2_thresholds.csv"
)
DEFAULT_REVIEW_POINTS = Path(
    "BassCoast_Phase2_Pixel_Sampling_outputs/basscoast_phase2b_review_points.csv"
)
DEFAULT_PHASE8_INTERVALS = Path(
    "BassCoast_Phase8_NDVI_Pilot_outputs/basscoast_phase8_embedding_ndvi_intervals.csv"
)
DEFAULT_PHASE8_METADATA = Path(
    "BassCoast_Phase8_NDVI_Pilot_outputs/basscoast_phase8_run_metadata.csv"
)
...
def run_external_enrichment(
    ...
    import phase3_dea_landcover_pipeline as phase3
    import phase8_ndvi_pilot as phase8
