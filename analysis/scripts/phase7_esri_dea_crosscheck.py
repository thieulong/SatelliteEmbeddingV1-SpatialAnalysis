...
DEFAULT_REVIEW_POINTS = (
    "BassCoast_Phase2_Pixel_Sampling_outputs/"
    "basscoast_phase2b_review_points.csv"
)
DEFAULT_DEA_LONG = (
    "BassCoast_Phase3_DEA_LandCover_Pipeline_outputs_full_sample/"
    "basscoast_phase3_dea_long.csv"
)
DEFAULT_OUTPUT_DIR = "BassCoast_Phase7_Esri_DEA_Crosscheck_outputs"
