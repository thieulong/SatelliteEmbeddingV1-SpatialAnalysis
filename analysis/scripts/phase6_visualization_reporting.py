...
from phase3_dea_landcover_pipeline import DEA_RASTER_ENV_OPTIONS, LEVEL3_LABELS, YEARS
from phase5_wall_to_wall_dea_summary import dea_cog_url
...
def parse_args():
    ...
    parser.add_argument("--phase5-dir", default="BassCoast_Phase5_WallToWall_DEA_Summary_outputs")
    parser.add_argument("--phase3-dir", default="BassCoast_Phase3_DEA_LandCover_Pipeline_outputs_full_sample")
    parser.add_argument("--raster-dir", default="GEE_BassCoast_Data")
    parser.add_argument("--output-dir", default="BassCoast_Phase6_Visualization_Report_outputs")
